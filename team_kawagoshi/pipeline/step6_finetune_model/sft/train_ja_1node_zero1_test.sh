...
OUTPUT_DIR="/storage2/output/SFT/ja_edinet_ft"
...
deepspeed ${ucllm_nedo_dev_train_dir}/llm-jp-sft/train_ja.py \
    ...
    --bf16 \
    --data_files OpenMathInstruct-1-1.8m-ja-120000-converted-nosp.jsonl amenokaku-code-instruct-merged.jsonl HachiML-Evol-hh-rlhf-gen3-1k-merged.jsonl HachiML-Evol-Alpaca-gen3-500-merged.jsonl HachiML-Hachi-Alpaca-merged.jsonl dolly-15k-jp-reviewed-by-Mixtral-instructions-merged.jsonl llm-jp-mbpp-ja-instructions-merged.jsonl kumapo-JAQKET-instructions-merged.jsonl alfredplpl-wikipedia-qa-ja-1m-instructions-merged.jsonl izumi-lab-llm-japanese-dataset-vanilla-instructions-merged.jsonl \
    --sample_sizes 5000 1000 1 1 2000 1 1 2000 2000 2000 \
