...
input_model_name_or_path="/storage2/output/finetune/chat/checkpoint/SFT_zero1_2024.05.25_23.21.35/checkpoint-910"
OUTPUT_DIR="/storage2/output/finetune/dpo_lora2"
...
deepspeed --master_port ${master_port} --hostfile ${hostfile} \
    ${ucllm_nedo_dev_train_dir}/llm-jp-dpo/train2.py \
    --num_train_epochs 20 \
