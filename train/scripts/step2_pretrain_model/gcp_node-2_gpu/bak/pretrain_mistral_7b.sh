...
dataset_file="${GENIAC_ROOT_DIR}/datasets_pre/20240418_preprocess/datasets/merged_japaneses/merged_japanese_100B.jsonl"
output_model_dir="${GENIAC_ROOT_DIR}/train_results/pretrained_models"
save_interval=1000
wandb_entity="weblab-geniac7"
wandb_project="pretrain_mistral"
...
# 12 * n_layers * hidden_size **2
# 5B: n_layers = 24, hidden_dim = 4096, ffn_hidden = 4096*4
## Mistral 7B
seq_len=2048
model="mistral_7b_test"
#model="mistral_5b"
#model="mistral_2.7b" # gpt-3の2.7Bを参考
model_size=7
num_layers=32
hidden_size=4096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #5096 #4096
...
activation_checkpoint="false" #changed so:2024/4/29/18:24
...
#        --input ${dataset_file} \
#        --output-prefix ${megatron_deepspeed_dir}/dataset/japanese_100B \
#        --dataset-impl mmap \
