...
dataset_dict = {
    ...
    "en": {
        ...
        "loader": load_dataset("json", split="train",
                               ...
                               streaming=True),
        "n_records": int(67500000/scale/10),
