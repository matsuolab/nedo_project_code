...
wandb_project="pretrain_mistral_9b_bf16"
...
normalization="rmsnorm"
norm_eps=1e-6
global_batch_size=1024 #1536 #1024 #1536
max_position_embeddings=32768  # following HF implementaiton, mistral suppports 4096*32 at maximum
lr=1.5e-4
min_lr=1.0e-6
init_std=0.009
...
before_checkpoint_path="${output_model_dir}/checkpoint/mistral_9b_9B_tok200B_lr1.5e-4_min1.0e-6_w3000M_d200B_cosine_gbs1024_mbs1_g16_z1_seed1234_rebase"
