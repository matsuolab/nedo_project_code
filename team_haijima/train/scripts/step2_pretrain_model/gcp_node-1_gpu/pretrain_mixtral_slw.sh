...
wandb_project="pretrain_mixtral_node1"
...
## Mixtral 7B*8
seq_len=8192 # 日本語データのseq_lenが短いのでmax 8kに設定
model="mixtral_7B*8_hf_moe"
model_size=7
num_layers=32
hidden_size=4096
ffn_hidden_size=14336
moe_hidden_size=14336
num_attn_heads=32
...
template_json="${megatron_deepspeed_dir}/examples_deepspeed/rebase/ds_config_gpt_slw_TEMPLATE.json"
