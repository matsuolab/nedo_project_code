...
def main(base_dir, index_from, index_to, num_worker=8):
    for index in range(index_from, index_to+1):
        path_input = Path(base_dir).joinpath(f'ja_{index:02}.json').as_posix()
        path_output = f'/persistentshare/storage/team_haijima/dataset_pre/20240418_preprocess/datasets/cc100/ja-{index:02}.jsonl'
...
if __name__ == '__main__':
    ...
    base_dir = '/persistentshare/storage/team_haijima/dataset_pre/20240410_CC100_filtering/filtered/'
