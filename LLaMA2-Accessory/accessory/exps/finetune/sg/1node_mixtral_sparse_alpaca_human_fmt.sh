...
data_config="${HOME}/LLaMA2-Accessory/accessory/configs/data/finetune/sg/alpaca_human.yaml"
...
exp_name="finetune/Mixtral_3node_finetune_multi_single_humanot_v5"
...
--batch_size 8 --accum_iter 12 --num_workers 8 \
...
--pretrained_path /storage7/finetune/Mixtral_3node_finetune_multi_single_v5/epoch0 \
