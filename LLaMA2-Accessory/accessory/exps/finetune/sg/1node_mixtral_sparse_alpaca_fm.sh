...
data_config="${HOME}/LLaMA2-Accessory/accessory/configs/data/finetune/sg/alpaca.yaml"
...
exp_name="finetune/Mixtral_3node_finetune_multi_single_v5"
...
--pretrained_path /storage7/finetune/Mixtral_3node_finetune_multi_v3/epoch2 \
