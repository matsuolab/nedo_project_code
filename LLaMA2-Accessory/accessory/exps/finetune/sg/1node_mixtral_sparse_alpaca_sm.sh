...
data_config="${HOME}/LLaMA2-Accessory/accessory/configs/data/finetune/sg/alpaca_singlemulti.yaml"
...
exp_name="finetune/Mixtral_3node_finetune_singlemulti_v6"
...
--pretrained_path /storage7/pretrain/Mixtral_3node_pretrain_0520/epoch0-iter134999 \
