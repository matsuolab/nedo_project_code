...
data_config="${HOME}/LLaMA2-Accessory/accessory/configs/data/finetune/sg/alpaca_ot.yaml"
...
exp_name="finetune/Mixtral_3node_finetune_single_multi_human_ot"
...
--pretrained_path /storage7/finetune/Mixtral_3node_finetune_single_multi_human/epoch2 \
