...
data_config="${HOME}/LLaMA2-Accessory/accessory/configs/data/finetune/sg/alpaca_multi.yaml"
...
exp_name="finetune/Mixtral_3node_finetune_single_multi_v6"
...
--pretrained_path /storage7/finetune/Mixtral_3node_finetune_single_v5/epoch0 \
