...
data_meta_path="${HOME}/LLaMA2-Accessory/data_example/file_list_honban.json"
data_root="/storage7/pretraining_shuffled/en1029_ja8301/"
...
exp_name="pretrain/Mixtral_3node_test"
...
--lr 0.001 --min_lr 0.00005 --warmup_iters 629789 --lr_decay_iters 1500000 --clip_grad 1 --weight_decay 0.02 \
...
--wandb-name "wandb_3B_3node_honban" \
--wandb-project "${PROJECT_NAME}" \
--resume /storage7/"$exp_name"/epoch0-iter1814999
