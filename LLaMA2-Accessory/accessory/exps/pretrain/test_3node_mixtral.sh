...
data_meta_path="${HOME}/LLaMA2-Accessory/data_example/file_list.json"
...
--batch_size 4 --accum_iter 24 --num_workers 1 \
...
--llama_type mixtral --tokenizer_path "$tokenizer_path" \
