...
exp_name="pretrain/Mixtral_3node_math_lr2"
...
--batch_size 8 --accum_iter 72 --num_workers 8 \
--lr 0.0002 --min_lr 0.0002 --warmup_iters 1 --lr_decay_iters 1 --clip_grad 1 --weight_decay 0.02 \
