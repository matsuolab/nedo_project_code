...
data_meta_path="${HOME}/LLaMA2-Accessory/data_example/file_list_math.json"
data_root="/storage7/team_data/gsm8k/parquet/"
...
exp_name="pretrain/Mixtral_3node_math"
...
--lr 0.001 --min_lr 0.001 --warmup_iters 1 --lr_decay_iters 1 --clip_grad 1 --weight_decay 0.02 \
...
--pretrained_path /storage7/"$exp_name"/epoch0-iter1934999 \
