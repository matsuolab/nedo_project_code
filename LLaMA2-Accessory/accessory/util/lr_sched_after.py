...
def adjust_learning_rate(optimizer, it, args):
    ...
    if it < args.warmup_iters/2: # 1) linear warmup for warmup_iters steps
        lr = args.lr * it / args.warmup_iters/5
    elif it < args.warmup_iters:
        lr = 1.6*args.lr * it / args.warmup_iters - 0.6*args.lr
