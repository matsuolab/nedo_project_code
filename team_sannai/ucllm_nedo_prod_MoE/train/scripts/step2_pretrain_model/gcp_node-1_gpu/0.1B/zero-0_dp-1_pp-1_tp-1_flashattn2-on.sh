...
output_model_dir="/persistentshare/storage/team_sannai/kume/"
save_interval=1000
...
if [[ -z ${input_tokenizer_file} ]] || [[ -z ${output_model_dir} ]] || [[ -z ${lr_warmup_steps} ]] || [[ -z ${dataset_index} ]]; then
    echo "Error: Missing required arguments."
    echo "Usage: ${0} --input_tokenizer_file <input_tokenizer_file> --output_model_dir <output_model_dir> --lr_warmup_steps <lr_warmup_steps> --dataset_index <dataset_index>"
    exit 1
fi
...
_ds="dataset${dataset_index}"
data_path="\
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_1/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_2/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_3/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_4/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_5/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_6/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_7/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_8/_text_document"
