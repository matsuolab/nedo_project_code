...
## GPUのattach
```
srun --nodelist=mlpre-g2-ghpc-[16-17] --gpus-per-node=4 --time=06:00:00 --pty bash -i
```
...
--input_tokenizer_file "mistralai/Mixtral-8x7B-v0.1" \
--dataset_index 1 \
--output_model_dir "/persistentshare/storage/team_sannai/fujimoto/model_weights/llama2"
```