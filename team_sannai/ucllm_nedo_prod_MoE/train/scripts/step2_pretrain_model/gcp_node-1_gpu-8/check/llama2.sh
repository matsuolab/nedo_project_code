...
while [[ ${#} -gt 0 ]]; do
    case ${1} in
        ...
        --dataset1) dataset1=${2}; shift ;;
        --dataset2) dataset2=${2}; shift ;;
...
if [[ -z ${input_tokenizer_file} ]] || [[ -z ${output_model_dir} ]] || [[ -z ${dataset_index} ]]; then
    echo "Error: Missing required arguments."
    echo "Usage: ${0} --input_tokenizer_file <input_tokenizer_file> --output_model_dir <output_model_dir> --dataset_index <dataset_index>"
    exit 1
fi
...
data_path="\
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_${dataset1}/_text_document \
1 /persistentshare/storage/team_sannai/team_la/seed/${_ds}/preprocessed_${dataset2}/_text_document"
